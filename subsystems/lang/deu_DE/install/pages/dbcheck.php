...
return array(
	...
	'check_insert'=>'Überprüfe INSERT Berechtigung',
	'check_select'=>'Überprüfe SELECT Berechtigung',
	'check_update'=>'Überprüfe UPDATE Berechtigung',
	'check_delete'=>'Überprüfe DELETE Berechtigung',
	'check_alter'=>'Überprüfe ALTER TABLE Berechtigung',
	'check_drop'=>'Überprüfe DROP TABLE Berechtigung',
	
	'installing_tables'=>'Installiere Tabellen',
	
	'saving_config'=>'Speichere Konfiguration',
