...
return array(
	...
	'config.php'=>'In der conf/config.php Datei wird die Konfiguration für die aktelle Site gespeichert. Dazu gehört auch die DB-Verbindung und das gewählte Thema.',
	...
	'install'=>'Das Install Verzeichnis beinhaltet alle Dateien von Exponent Installationsassistent. Sobald der Assistent einmal ausgeführt wurde, wird das Verzeichnis automatisch gelöscht. Dazu werden Schreibrechte für dieses Verzeichnis benötigt.',
	...
	'extensionuploads'=>'Wenn Sie das Upload Extension Feature im Administrator Control Panel benutzen, werden die Dateien zuerst um Verzeichnis extensionuploads temporär gespeichert. Deshalb benötigt der Webserver vollen Zugriff auf dieses Verzeichnis.',
	'files'=>'Alle hochgeladenen Content Dateien (resources, importierte Daten, Bilder, etc.) werden im Verzeichnis files/  gespeichert. Der Webserver braucht dafür Schreib- und Leserechte.  Falls der Test negativ ausfällt sollten Sie die Berechtigungen manuall ändern.',
	...
	'upload_desc'=>'Server Administratoren können PHP uploads deaktivieren. Zusätzlich können schlecht konfigurierte Server Probleme beim Verarbeiten der hochgelandenen Dateien verursachen. Ohne eine Uploadmöglichkeit wird jedoch nur eine kleiner Teil der Fähigkeiten von benutzbar sein weil es keine Möglichkeit gibt z. B. Bilder oder Dateien hochzuladen.',
	'tempfile'=>'Temporäre Dateierstellung',
	'tempfile_desc'=>'Verschiedenen Exponenterweiterungen müssen temporäre Dateien erstellen. Normallerweise weist diese Fehlermeldung auf Probeme bei der Verzeichnisberechtigung für die "tmp/" Datei und das Verzeichnis hin.',
);
