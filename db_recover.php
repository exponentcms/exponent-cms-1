 ...
 *
 * This is provided as a last resort to people who have locked themselves out of
 * their database with corrupted tables or delete admin accounts.
 *
 * This script exits initially by default, to prevent unauthorized access.
 * In the event that you need to recover your database structure, comment
 * out the exit() line, below.
 *
 * @author James Hunt
 * @copyright 2004 James Hunt and OIC Group, Inc.
 *
