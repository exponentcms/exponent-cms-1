...
<div class="newsmodule default">
	...
	{foreach from=$featured_items item=newsitem}
		...
		<div class="item {cycle values='odd,even'}">
			...
			<div class="itemactions">
				...
				{if $permissions.manage_approval == 1}
					<a href="{link module=workflow datatype=newsitem m=newsmodule s=$__loc->src action=revisions_view id=$newsitem->id}" title="{$_TR.alt_revisions}" alt="{$_TR.alt_revisions}"><img src="{$smarty.const.ICON_RELATIVE}revisions.png" title="{$_TR.alt_revisions}" alt="{$_TR.alt_revisions}"/></a>
				{/if}
			</div>
			{/permissions}
