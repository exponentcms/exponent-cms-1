...
{/if}
{/permissions}
   <img style="margin:4px 0 0 0" src="{$smarty.const.ICON_RELATIVE}whosonline.jpg"> 
{if $show_users == true}

<div class="bb_whosonline"><span>There's <strong>{$anon_users}</strong> Guests<br />
and these members:
</span>
...
</div>{/if}<img src="{$smarty.const.ICON_RELATIVE}sidebox_bottom.gif">
