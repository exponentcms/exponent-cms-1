...
{if $permissions.configure == 1}
	<a href="{link action=edit_wizard module="wizardmodule" id=$wizard_id"}" title="{$_TR.alt_configure}"><img class="mngmnt_icon" border="0" src="{$smarty.const.ICON_RELATIVE}configure.png" /></a>
{/if}
{/permissions}
