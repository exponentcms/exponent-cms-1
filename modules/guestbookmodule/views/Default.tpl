...
<div style="margin-left: 20px; margin-right: 20px;text-align:center">
	<a class="mngmntlink guestbook_mngmntlink" href="{link action=_view_page page=1}">
		<img class="mngmnt_icon" style="border:none;" src="{$smarty.const.ICON_RELATIVE}right.png" title="{$_TR.next}" alt="{$_TR.next}" align="absmiddle" style="margin-right: 5px;" /> {$_TR.next}
	</a>
</div>
{/if}
</div>