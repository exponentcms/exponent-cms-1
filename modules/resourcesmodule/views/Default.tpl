...
{if $config->enable_podcasting == 1}
        <a href="{podcastlink}"><img class="mngmnt_icon" src="{$smarty.const.ICON_RELATIVE}podcast_small.gif" height="20" width="20" title="{$_TR.alt_rssfeed}" alt="{$_TR.alt_rssfeed}" /></a>
{/if}
