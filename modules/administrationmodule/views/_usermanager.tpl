...
<a class="mngmntlink administration_mngmntlink" href="{link action=umgr_editprofile id=0}">{$_TR.new_user}</a>
 ...
 {paginate objects=$users paginateName="useradmin" modulePrefix="administration" rowsPerPage=20}{literal}
	function links(object) {
		...
		{/literal}{link module=$info.module action=$info.action}
			out = '<a class="mngmntlink administration_mngmntlink" href="'+eXp.makeLink('module','administrationmodule','action','umgr_edit','id',object.var_id) +'"><img class="mngmnt_icon" border="0" src="{$smarty.const.ICON_RELATIVE}edit.png" /></a>'+
