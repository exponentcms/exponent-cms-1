...
<table cellpadding="2" cellspacing="0" width="100%" border="0">
	...
	<tr class="row {cycle values='odd,even'}_row">
		...
		<td valign="top">
			<a class="mngmntlink administration_mngmntlink" href="{link action=admin_editpolicy id=$policy->id}"><img src="{$smarty.const.ICON_RELATIVE}edit.gif" border="0"/></a>
			<a class="mngmntlink administration_mngmntlink" href="{link action=admin_confirmdeletepolicy id=$policy->id}"><img src="{$smarty.const.ICON_RELATIVE}delete.gif" border="0"/></a>
