...
<table cellpadding="0" cellspacing="0" border="0" width="100%" style=" background:url(themes/portaltheme/images/body-header.jpg) 0px 0px no-repeat;">
<tr>
<td valign="top" style="padding: 18px 35px 18px 18px; background:url(themes/portaltheme/images/paragraphback-left.jpg) 0px 45px no-repeat">
