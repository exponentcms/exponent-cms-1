		...
		{if ($permissions.administrate == 1 || $permissions.edit_module == 1 || $permissions.delete_module == 1 || $permissions.add_module == 1 || $container->permissions.administrate == 1)}
			{permissions level=$smarty.const.UILEVEL_STRUCTURE}
				<div id="module{$container->id}" class="container_modulewrapper">
					...
					YAHOO.expadminmenus["{$container->info.class}{$container->id}"] = {getchromemenu module=$container rank=1 rerank='false'}; 
					{/script}
			{/permissions}
		{/if}
		{$container->output}
	...
	{else}
		{permissions level=$smarty.const.UILEVEL_STRUCTURE}
			{if $permissions.add_module == 1 && $hidebox == 0}
				<a class="addmodule" href="{link action=edit rerank=0 rank=$rank}"><span class="addtext">{$_TR.add_new}</span></a>
			{/if}
		{/permissions}	
	{/if}	
</td>
		...
		{if ($permissions.administrate == 1 || $permissions.edit_module == 1 || $permissions.delete_module == 1 || $permissions.add_module == 1 || $container->permissions.administrate == 1)}
			{permissions level=$smarty.const.UILEVEL_STRUCTURE}
				<div id="module{$container->id}" class="container_modulewrapper">
					...
					{script unique="module`$container->id`"}
					YAHOO.expadminmenus["{$container->info.class}{$container->id}"] = {getchromemenu module=$container rank=2 rerank='false'}; 
					{/script}
			{/permissions}
		{/if}
		{$container->output}
		...
		{if ($permissions.administrate == 1 || $permissions.edit_module == 1 || $permissions.delete_module == 1 || $permissions.add_module == 1 || $container->permissions.administrate == 1)}
			{permissions level=$smarty.const.UILEVEL_STRUCTURE}
				<div id="module{$container->id}" class="container_modulewrapper">
					...
					{script unique="module`$container->id`"}
					YAHOO.expadminmenus["{$container->info.class}{$container->id}"] = {getchromemenu module=$container rank=3 rerank='false'}; 
					{/script}
			{/permissions}
		{/if}
		{$container->output}
		...
		{if ($permissions.administrate == 1 || $permissions.edit_module == 1 || $permissions.delete_module == 1 || $permissions.add_module == 1 || $container->permissions.administrate == 1)}
			{permissions level=$smarty.const.UILEVEL_STRUCTURE}
				<div id="module{$container->id}" class="container_modulewrapper">
					...
					{script unique="module`$container->id`"}
					YAHOO.expadminmenus["{$container->info.class}{$container->id}"] = {getchromemenu module=$container rank=4 rerank='false'}; 
					{/script}
			{/permissions}
		{/if}
		{$container->output}
