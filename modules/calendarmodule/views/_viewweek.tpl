 ...
 *
 *}
<p><a class="mngmntlink calendar_mngmntlink" href="{link action=viewmonth time=$startweek}" title="{$_TR.alt_view_month}">{$_TR.view_month}</a></p>
<p class="caption"><a class="mngmntlink calendar_mngmntlink" href="{link action=viewweek time=$startprevweek}"><img class="mngmnt_icon" src="{$smarty.const.ICON_RELATIVE}left.png" title="{$_TR.prev_week}" alt="{$_TR.prev_week}" /></a> <span>{$_TR.view_week} {$startweek|format_date:"%B %e, %Y"}</span> <a class="mngmntlink calendar_mngmntlink" href="{link action=viewweek time=$startnextweek}"><img class="mngmnt_icon" src="{$smarty.const.ICON_RELATIVE}right.png" title="{$_TR.next_week}" alt="{$_TR.next_week}" /></a></p>
<dl class="viewweek">
