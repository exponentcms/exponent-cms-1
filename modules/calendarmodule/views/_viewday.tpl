 ...
 *
 *}
<p><a class="mngmntlink calendar_mngmntlink" href="{link action=viewweek time=$now view=_viewweek}" title="{$_TR.alt_view_week}">{$_TR.view_week}</a></p>
<p class="caption"><a class="mngmntlink calendar_mngmntlink" href="{link action=viewday time=$prevday}"><img class="mngmnt_icon" src="{$smarty.const.ICON_RELATIVE}left.png" title="{$_TR.prev_day}" alt="{$_TR.prev_day}" /></a> <span>{$now|format_date:"%A, %B %e, %Y"}</span> <a class="mngmntlink calendar_mngmntlink" href="{link action=viewday time=$nextday}"><img class="mngmnt_icon" src="{$smarty.const.ICON_RELATIVE}right.png" title="{$_TR.next_day}" alt="{$_TR.next_day}" /></a></p>
<ul class="viewday">
