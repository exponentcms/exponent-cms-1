...
<div align="center">
	<table cellspacing="0" cellpadding="0" border="0" width="75%">
		<tr>
			<td class="header" style="padding-left: 5px;" colspan="2">{$_TR.tag_label}s</td>
		</tr>
		{foreach name=a from=$existing_tags item=tag}
			<tr class="row {cycle values=odd_row,even_row}">
				...
				<td style="text-align: right; padding-right: 5px;">
					<a href="{link module=tags action=delete_tag id=$tag->id}" onclick="return confirm('{$_TR.delete_confirm}');" title="{$_TR.alt_delete}" style="border: 0px solid black;">
