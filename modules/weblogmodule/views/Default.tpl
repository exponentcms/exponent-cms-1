...
<div class="weblogmodule default">
	...
	{if $total_posts > $__viewconfig.num_posts}
		{if $__viewconfig.num_posts > 1}
			<p><a class="mngmntlink weblog_mngmntlink" href="{link action=view_page page=1}">{$_TR.next} &gt;</a></p>
		{else}
			<p><a class="moreposts mngmntlink" href="{link action=view_page page=0}">{$_TR.view_all}{if $moduletitle != ""} in &quot;{$moduletitle}&quot;{/if}</a></p>
		{/if}
	{/if}
	{permissions level=$smarty.const.UILEVEL_NORMAL}
