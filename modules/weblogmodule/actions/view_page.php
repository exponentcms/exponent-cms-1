...
$posts = $db->selectObjects('weblog_post',"location_data='".serialize($loc)."'".$where . ' ORDER BY posted DESC LIMIT '.$config->items_per_page.' OFFSET '.($_GET['page']*$config->items_per_page));
