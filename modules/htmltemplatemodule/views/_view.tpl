...
<a class="mngmntlink htmltemplate_mngmntlink" href="{link action=edit id=$template->id}">
	<img src="{$smarty.const.ICON_RELATIVE}edit.gif" border="0" title="Edit this HTML Template" alt="Edit this HTML Template" />
</a>
{/if}
...
<a class="mngmntlink htmltemplate_mngmntlink" href="{link action=delete id=$template->id}" onClick="return confirm('Are you sure you want to delete this HTML Template?');">
	<img src="{$smarty.const.ICON_RELATIVE}delete.gif" border="0" title="Delete this HTML Template" alt="Delete this HTML Template" />
</a>
{/if}
{/permissions}
