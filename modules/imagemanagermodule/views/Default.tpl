...
{if $permissions.administrate == 1}
	<a href="{link action=userperms _common=1}"><img border="0" src="{$smarty.const.ICON_RELATIVE}userperms.gif" title="Assign user permissions on this Image Manager" alt="Assign user permissions on this Image Manager" /></a>&nbsp;
	<a href="{link action=groupperms _common=1}"><img border="0" src="{$smarty.const.ICON_RELATIVE}groupperms.gif" title="Assign group permissions on this Image Manager" alt="Assign group permissions on this Image Manager" /></a>
{/if}
{if $permissions.configure == 1}
	<a href="{link action=configure _common=1}"><img border="0" src="{$smarty.const.ICON_RELATIVE}configure.gif" title="Change the configuration of this Image Manager" alt="Change the configuration of this Image Manager" /></a>
{/if}
	...
	<tr>
		...
		<td>
			...
			<a class="mngmntlink imagemanager_mngmntlink" href="{link action=delete id=$item->id}" onClick="return confirm('Are you sure you want to delete this Image?');">
				<img src="{$smarty.const.ICON_RELATIVE}delete.gif" border="0" title="Delete this Image" alt="Delete this Image" />
			</a>
			{/if}
			{/permissions}
		</td>
