...
if (!defined('DISPLAY_THEME_REAL')) define('DISPLAY_THEME_REAL','coolwatertheme');
...
if (!defined('DISPLAY_DEFAULT_TIMEZONE')) define ('DISPLAY_DEFAULT_TIMEZONE', date_default_timezone_get());
?>