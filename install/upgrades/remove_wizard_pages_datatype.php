...
#
##################################################
class remove_wizard_pages_datatype extends upgradescript {
        protected $from_version = '0.96.6';
        protected $to_version = '0.96.6'; 

        function name() {
                return "Removing Old Datatype (wizard_pages)";
        }
