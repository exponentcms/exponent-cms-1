 ...
 *}
			<div class="search">
				...
				<input type="image" name="imageField" class="searchbutton" src="{$smarty.const.THEME_RELATIVE}images/button-search.jpg" />
				<input type="text" name="search_string" class="searchfield" />
				</form>
