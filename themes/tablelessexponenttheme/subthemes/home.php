...
if (exponent_theme_inaction()) { include THEME_ABSOLUTE.'/index.php'; exit(); }
exponent_theme_setFlow();
?>
...
<div class="shell">
	...
	<div class="threecolshell" >
		...
		********************************************************
		...
		<div class="maincontenttop" style="border:1px solid #000000">
		...
		<!-- START CENTER AND LEFT COLUMN  -->
		 <div class="maincontent">
			 <div class="maincontentpadding">
				...
				<!-- grey text box styled by greybox.css  -->
				<!-- this box spans both left and center column  -->

				<!-- 
				********************************************************
				center column container styled by centercolumn.css 
				********************************************************
				-->
				
				<!-- center column styled by centercolumn.css  -->
				<div class="centercolumn">
				<?php exponent_theme_showSectionalModule("containermodule","Default","","@center"); ?>
					<!-- posties styled by postytext.css  -->
				</div>
				 
				 
				<!-- 
				********************************************************
				left column container styled by leftcolumn.css 
				********************************************************
				-->
