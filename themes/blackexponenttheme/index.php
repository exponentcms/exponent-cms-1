	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td style=" padding:0 2px 0 0;" nowrap="nowrap">
				...
				<div id="getexponent"><a href="http://www.exponentcms.org/index.php?section=116">Download Exponent <img src="<?php echo THEME_RELATIVE;?>images/get.jpg" align="absmiddle" alt="Download Exponent" name="Get icon" border="0"></a></div>
			</div>
