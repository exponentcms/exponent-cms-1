...
<tr><td width="22" valign="top">
	{if $mimetype->icon != ""}
	<img src="{$smarty.const.MIMEICON_RELATIVE}{$mimetype->icon}" alt="mimetype icon" />
	{/if}
</td>
<td>
	...
	<br />
	{/if}
	<a class="downloadlink resources_mngmntlink" href="{$smarty.const.PATH_RELATIVE}{$file->directory}/{$file->filename}">Download</a>
	{if $permissions.edit == 1 || $resource->permissions.edit == 1}
