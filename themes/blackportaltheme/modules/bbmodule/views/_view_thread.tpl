...
<div style="padding:15px;">
		...
		<div class="bb_bio" >
			<div class="bb_avitar" style="text-align:center">
				{if $thread->poster->avatar_path != ""}
					<a href="{link module=loginmodule action=showuserprofile id=$thread->poster->id}" title="View user profile" style="border:none;"><img style="border:none;" src="{$thread->poster->avatar_path}" alt="avatar" /></a>
				{/if}
	...
	<div class="bb_reply{cycle values="_light,_dark"}" style="display:table;">
		...
		<div class="bb_bio" >
			<div class="bb_avitar" style="text-align:center">
				{if $reply->poster->avatar_path != ""}
					<a href="{link module=loginmodule action=showuserprofile id=$reply->poster->id}" title="View user profile" style="border:none;"><img style="border:none;" src="{$reply->poster->avatar_path}" alt="" /></a>
				{/if}
      ...
      {/foreach}
		...
		{if $permissions.reply == 1}
		<div>
			<a href="{link module=bbmodule action=edit_post parent=$thread->id quote=$reply->id}" style="border:none;"><img style="border:none;" src="{$smarty.const.THEME_RELATIVE}images/btn_qtr.jpg" title="{$_TR.alt_btn_qtr}" alt="{$_TR.alt_btn_qtr}" /></a>
		</div>		
		{/if}
	</div><br />
{/foreach}
...
{if $permissions.reply == 1}
<br /><a href="{link action=edit_post parent=$thread->id}" style="border:none;"><img style="border:none;" src="{$smarty.const.THEME_RELATIVE}images/btn_postreply.gif" title="{$_TR.alt_btn_postreply}" alt="{$_TR.alt_btn_postreply}" /></a>
{else}
  {if $loggedin == 1}
