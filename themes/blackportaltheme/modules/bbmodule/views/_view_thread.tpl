...
<div style="padding:15px;">
	...
	<div>
		{if $permissions.reply == 1}
			<a href="{link action=edit_post parent=$thread->id}" style="border:0"><img src="{$smarty.const.THEME_RELATIVE}images/btn_postreply.gif" border="0" /></a>
		{else}
	...
	<div class="bb_reply{cycle values="_light,_dark"}" style="display:table;">
      ...
      {/foreach}
		...
		{if $permissions.reply == 1}
		<div>
			<a href="{link module=bbmodule action=edit_post parent=$thread->id quote=$reply->id}" style="border:none"><img src="{$smarty.const.THEME_RELATIVE}images/btn_qtr.jpg" border="0"  /></a>
		</div>		
		{/if}
	</div><br />
{/foreach}
...
{if $permissions.reply == 1}
<br /><a href="{link action=edit_post parent=$thread->id}" style="border:none"><img src="{$smarty.const.THEME_RELATIVE}images/btn_postreply.gif" border="0" /></a>
{else}
  {if $loggedin == 1}
