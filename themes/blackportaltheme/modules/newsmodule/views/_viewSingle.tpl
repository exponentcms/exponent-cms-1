...
Von: {attribution user_id=$newsitem->poster} am {$newsitem->real_posted|format_date:$smarty.const.DISPLAY_DATE_FORMAT}
</div><div id="inews_textbody">
{$newsitem->body}
</div>
</div>
<div style="padding: 15px;">
<img style="border:none;" src="{$smarty.const.THEME_RELATIVE}images/icons/arrow_left.gif" align="absmiddle" alt="Sitetree" /><a href="javascript:history.go(-1)">Zurück gehen</a>
</div>