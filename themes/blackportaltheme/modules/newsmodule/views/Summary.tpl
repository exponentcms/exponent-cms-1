...
{/permissions}
{if $enable_rss == true}
        <a href="{rsslink}"><img class="mngmnt_icon" border="0" src="{$smarty.const.ICON_RELATIVE}rss-feed.gif" title="Die aktuellsten Blog-News für deinen Newsreader oder Browser" /></a>
	{/if}