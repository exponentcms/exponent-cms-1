...
<a class="mngmntlink news_mngmntlink" style="color: #fff" href="{$wf_linkbase}summary">View Approval</a>
{/if}
{if $permissions.manage_approval == 1 && ($textitem->id != 0 && $textitem->approved != 0)}
	&nbsp;&nbsp;&nbsp;<a class="mngmntlink text_mngmntlink" style="color: #fff" href="{$wf_linkbase}revisions_view&id={$textitem->id}">
		Revisions
	</a>
{/if}
